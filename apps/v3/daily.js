/* ═══════════════════════════════════════════════════════════════════════
   V3 FORK POINT: apps/v3/daily.js copied verbatim from apps/board/daily.js
   @ 2026-09-03 (no logic edits) — it imports the forked ./engine.js +
   ./state.js (rwf.v3 keys). DANGER ZONE ramp copy is battle language.
   ═══════════════════════════════════════════════════════════════════════ */
/* ═══════════════════════════════════════════════════════════════════════
   RWF DAILY — apps/board FORK (V2). FORK POINT: copied verbatim from
